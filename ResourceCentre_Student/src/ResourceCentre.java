...
=======
		...
		Chromebook ch = new Chromebook(tag, description, os);
		return ch;

>>>>>>> branch 'master' of https://github.com/20004375-Jefferson-Tok/ResourceCentre_Student.git
	}

	public static void addChromebook(ArrayList<Chromebook> chromebookList, Chromebook ch) {
		// write your code here
		chromebookList.add(ch);
		System.out.println("Chromebook added added");
	}
